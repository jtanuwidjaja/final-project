<?php
    ...
    include("./PHPMailer/send_new_pass.php");
...
<head>
	...
	<title>Forgot password - MRBS</title>
...
<body>
    ...
    <nav class="navbar navbar-inverse">
      <div class="container">
       ...
       <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Forgot password
<!--                    <small>We are always ready to help you</small>-->
                </h1>
                <p>If you forgot your password enter your email and we send to you temporary password</p>
            </div>
       </div>
        ...
        <form action="" method="post" onchange="checkform()" role="form">
           <div class="row"> 
                <div class="form-group col-lg-4">
                    <label >Email</label>
                    <input type="email" class="form-control rq" id="email" name="email" placeholder="Enter email">
                </div>
           </div>
            
            <div class="row col-lg-4">
                <button type="submit" class="btn btn-primary" name="sendpass" id="signup" disabled>Send password</button>
            </div>
