...
<!--                    <small>We are always ready to help you</small>-->
        ...
        <form action="" method="post" onchange="checkform()" role="form">
           <div class="row"> 
            ...
            <div class="row"> 
               <div class="form-group col-lg-4">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" class="form-control rq"  id="buildingaddress" name="buildingaddress" placeholder="Enter Building Address" <?php echo 'value="'.$buildingaddress.'"'; ?>>
                </div>
            </div>
            <div class="row"> 
               <div class="form-group col-lg-4">
            ...
            <div class="row"> 
               <div class="form-group col-lg-4">
                     <p><a href="building.php">Back to previous page</a></p>
                </div>
            </div>
        </form>
       </div>  
